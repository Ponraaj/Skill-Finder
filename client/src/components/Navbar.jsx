        ...
        <div className='bg-white p-2 m-3'>
            <nav className='flex justify-between items-center w-[100%] mx-auto'>
                <div className='flex gap-1'>
                    ...
                    <p className='flex font-bold gap-2 text-2xl'>Skill Finder</p>
                </div>
                <div className='nav-links md:static absolute bg-white md:min-h-fit min-h-[10vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5'>
